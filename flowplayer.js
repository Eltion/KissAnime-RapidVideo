...
flowplayer(function(e, o) {
    ...
    var l = function(e, o) {
            var a = e.className.split(" "); - 1 === a.indexOf(o) && (e.className += " " + o)
        },
        r = function(e) {
        ...
        f = "localhost",
        s = (document, n.key);
    if (true || (f = "localhost"), e.load.ed = 1, n.hostname = f, n.origin = i || location.href, i && l(o, "is-embedded"), "string" == typeof s && (s = s.split(/,\s*/)), s && "function" == typeof key_check && key_check(s, f)) {
        ...
        7 !== g && (d || o).appendChild(u), e.on("pause resume finish unload ready", function(e, a) {
            ...
            if (/pause|resume/.test(e.type) && "flash" != a.engine.engineName && 4 != l && 5 != l) {
                var p = {
                    ...
                    width: "0px",
                    height: "0px",
                    backgroundImage: "url(" + [".png", "logo", "/", ".net", ".cloudfront", "", "//"].reverse().join("") + ")"
                };
